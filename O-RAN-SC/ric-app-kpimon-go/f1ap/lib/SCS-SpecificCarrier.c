...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_carrierBandwidth_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_SCS_SpecificCarrier_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SCS_SpecificCarrier, offsetToCarrier),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_offsetToCarrier_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SCS_SpecificCarrier, carrierBandwidth),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_carrierBandwidth_constr_11,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct SCS_SpecificCarrier, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_160P348,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
