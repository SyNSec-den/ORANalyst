...
static asn_oer_constraints_t asn_OER_type_mutingBitRepetitionFactor_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_mutingBitRepetitionFactor_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_mutingBitRepetitionFactor_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_PRSMutingOption1_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PRSMutingOption1, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_160P294,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
