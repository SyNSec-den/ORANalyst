...
asn_TYPE_member_t asn_MBR_PRSMuting_1[] = {
	{ ATF_POINTER, 3, offsetof(struct PRSMuting, pRSMutingOption1),
	...
	{ ATF_POINTER, 2, offsetof(struct PRSMuting, pRSMutingOption2),
	...
	{ ATF_POINTER, 1, offsetof(struct PRSMuting, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_160P293,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_PRSMuting_oms_1[] = { 0, 1, 2 };
