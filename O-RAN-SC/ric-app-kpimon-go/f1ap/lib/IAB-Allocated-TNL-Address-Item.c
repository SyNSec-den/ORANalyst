...
asn_TYPE_member_t asn_MBR_IAB_Allocated_TNL_Address_Item_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct IAB_Allocated_TNL_Address_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_160P174,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_IAB_Allocated_TNL_Address_Item_specs_1 = {
