...
static asn_oer_constraints_t asn_OER_type_RelativeTime1900_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	64	/* (SIZE(64..64)) */};
...
asn_TYPE_descriptor_t asn_DEF_RelativeTime1900 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_RelativeTime1900_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_RelativeTime1900_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		RelativeTime1900_constraint
	},
	0, 0,	/* No members */
