...
asn_TYPE_member_t asn_MBR_SLDRBs_FailedToBeModified_Item_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SLDRBs_FailedToBeModified_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_160P366,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_SLDRBs_FailedToBeModified_Item_specs_1 = {
