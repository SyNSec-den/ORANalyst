...
asn_mutate_result_t
OCTET_STRING_mutate(const asn_TYPE_descriptor_t *td, void **sptr,
                         const asn_encoding_constraints_t *constraints) {
	printf("OCTET_STRING_mutate\n");
	// TODO: add more mutation strategies
	asn_random_fill_result_t res = OCTET_STRING_random_fill(td, sptr, constraints, 1048576);
	printf("OCTET_STRING_mutate: %d\n", res.code);
