...
asn_mutate_result_t
NativeInteger_mutate(const asn_TYPE_descriptor_t *td, void **sptr,
                          const asn_encoding_constraints_t *constraints) {
	printf("NativeInteger_mutate\n");
	asn_random_fill_result_t res = NativeInteger_random_fill(td, sptr, constraints, 1048576);
