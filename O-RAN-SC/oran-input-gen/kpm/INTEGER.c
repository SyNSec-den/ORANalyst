...
asn_mutate_result_t
INTEGER_mutate (const asn_TYPE_descriptor_t *td, void **sptr,
                    const asn_encoding_constraints_t *constraints) {
	printf("INTEGER_mutate\n");
	asn_random_fill_result_t res = INTEGER_random_fill(td, sptr, constraints, 1048576);
