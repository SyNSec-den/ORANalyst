...
asn_mutate_result_t
SET_OF_mutate(const asn_TYPE_descriptor_t *td, void **sptr,
                   const asn_encoding_constraints_t *constraints) {
	printf("SET_OF_mutate\n");
	//TODO: implement more mutation methods
	asn_random_fill_result_t res = SET_OF_random_fill(td, sptr, constraints, 1048576);
