...
asn_mutate_result_t
BIT_STRING_mutate(const asn_TYPE_descriptor_t *td, void **sptr,
                       const asn_encoding_constraints_t *constraints) {
    printf("BIT_STRING_mutate\n");
    // TODO: implement mutation strategy
    asn_random_fill_result_t res = BIT_STRING_random_fill(td, sptr, constraints, 1048576);
    printf("BIT_STRING_mutate: %d\n", res.code);
