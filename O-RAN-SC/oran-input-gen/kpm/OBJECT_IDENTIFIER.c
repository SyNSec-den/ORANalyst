...
asn_mutate_result_t
OBJECT_IDENTIFIER_mutate(const asn_TYPE_descriptor_t *td, void **sptr,
                    const asn_encoding_constraints_t *constraints) {
    printf("BOOLEAN_mutate\n");
    // TODO: implement mutation strategy
    asn_random_fill_result_t res = OBJECT_IDENTIFIER_random_fill(td, sptr, constraints, 1048576);
    printf("BOOLEAN_mutate: %d\n", res.code);
