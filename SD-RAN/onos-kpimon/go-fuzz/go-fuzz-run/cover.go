...
var (
	trackedDir    = "gopath/src/github.com/onosproject/onos-kpimon/"
	baseDir       = "/go/src/github.com/onosproject/onos-kpimon"
...
func setupCover() {
	...
	htmlContent := generateHTML(blackLast, greenLast, redLast, blackCummulative, greenCummulative, redCummulative)
...
func generateHTML(blackLast, greenLast, redLast, blackCummulative, greenCummulative, redCummulative int) string {
