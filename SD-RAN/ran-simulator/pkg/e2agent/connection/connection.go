...
import (
	...
	connectionupdateitem "github.com/onosproject/ran-simulator/pkg/utils/e2ap/connectionupdate/connectionUpdateitemie"
...
func (e *e2Connection) setup() error {
	...
	log.Infof("RanFunctions: %+v", e.registry.GetRanFunctions())
	...
	log.Infof("setupRequest: %+v", setupRequest)

	e2SetupRequest, err := setupRequest.Build()

	log.Infof("E2 Setup Request is built: %+v", e2SetupRequest)
