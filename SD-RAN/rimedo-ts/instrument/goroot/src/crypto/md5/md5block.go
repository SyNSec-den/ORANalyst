...
//line /usr/local/go/src/crypto/md5/md5block.go:7
package md5
...
//line /usr/local/go/src/crypto/md5/md5block.go:14
	_go_fuzz_dep_.CoverTab[9592]++

							a, b, c, d := dig.s[0], dig.s[1], dig.s[2], dig.s[3]

							for i := 0; i <= len(p)-BlockSize; i += BlockSize {
//line /usr/local/go/src/crypto/md5/md5block.go:18
		_go_fuzz_dep_.CoverTab[9594]++

								q := p[i:]
								q = q[:BlockSize:BlockSize]

//line /usr/local/go/src/crypto/md5/md5block.go:24
		aa, bb, cc, dd := a, b, c, d

//line /usr/local/go/src/crypto/md5/md5block.go:27
...
//line /usr/local/go/src/crypto/md5/md5block.go:45
...
//line /usr/local/go/src/crypto/md5/md5block.go:63
...
//line /usr/local/go/src/crypto/md5/md5block.go:81
...
//line /usr/local/go/src/crypto/md5/md5block.go:99
...
//line /usr/local/go/src/crypto/md5/md5block.go:117
		a += aa
								b += bb
								c += cc
								d += dd
//line /usr/local/go/src/crypto/md5/md5block.go:120
		// _ = "end of CoverTab[9594]"
	}
//line /usr/local/go/src/crypto/md5/md5block.go:121
	// _ = "end of CoverTab[9592]"
//line /usr/local/go/src/crypto/md5/md5block.go:121
	_go_fuzz_dep_.CoverTab[9593]++

//line /usr/local/go/src/crypto/md5/md5block.go:124
	dig.s[0], dig.s[1], dig.s[2], dig.s[3] = a, b, c, d
//line /usr/local/go/src/crypto/md5/md5block.go:124
	// _ = "end of CoverTab[9593]"
}

//line /usr/local/go/src/crypto/md5/md5block.go:125
