...
//line /usr/local/go/src/vendor/golang.org/x/net/http2/hpack/static_table.go:4
package hpack
...
//line /usr/local/go/src/vendor/golang.org/x/net/http2/hpack/static_table.go:188
