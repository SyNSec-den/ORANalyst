...
//line /usr/local/go/src/math/rand/normal.go:5
package rand
...
//line /usr/local/go/src/math/rand/normal.go:19
const (
	rn = 3.442619855899
)

func absInt32(i int32) uint32 {
//line /usr/local/go/src/math/rand/normal.go:23
	_go_fuzz_dep_.CoverTab[2951]++
							if i < 0 {
//line /usr/local/go/src/math/rand/normal.go:24
		_go_fuzz_dep_.CoverTab[2953]++
								return uint32(-i)
//line /usr/local/go/src/math/rand/normal.go:25
		// _ = "end of CoverTab[2953]"
	} else {
//line /usr/local/go/src/math/rand/normal.go:26
...
//line /usr/local/go/src/math/rand/normal.go:26
	_go_fuzz_dep_.CoverTab[2952]++
							return uint32(i)
//line /usr/local/go/src/math/rand/normal.go:27
	// _ = "end of CoverTab[2952]"
}

// NormFloat64 returns a normally distributed float64 in
//line /usr/local/go/src/math/rand/normal.go:30
...
//line /usr/local/go/src/math/rand/normal.go:37
func (r *Rand) NormFloat64() float64 {
//line /usr/local/go/src/math/rand/normal.go:37
	_go_fuzz_dep_.CoverTab[2955]++
							for {
//line /usr/local/go/src/math/rand/normal.go:38
		_go_fuzz_dep_.CoverTab[2956]++
								j := int32(r.Uint32())
								i := j & 0x7F
								x := float64(j) * float64(wn[i])
								if absInt32(j) < kn[i] {
//line /usr/local/go/src/math/rand/normal.go:42
			_go_fuzz_dep_.CoverTab[2959]++

									return x
//line /usr/local/go/src/math/rand/normal.go:44
			// _ = "end of CoverTab[2959]"
		} else {
//line /usr/local/go/src/math/rand/normal.go:45
...
//line /usr/local/go/src/math/rand/normal.go:45
		_go_fuzz_dep_.CoverTab[2957]++
								...
								if i == 0 {
//line /usr/local/go/src/math/rand/normal.go:47
			_go_fuzz_dep_.CoverTab[2961]++

									for {
//line /usr/local/go/src/math/rand/normal.go:49
				_go_fuzz_dep_.CoverTab[2964]++
										x = -math.Log(r.Float64()) * (1.0 / rn)
										y := -math.Log(r.Float64())
										if y+y >= x*x {
//line /usr/local/go/src/math/rand/normal.go:52
					_go_fuzz_dep_.CoverTab[2965]++
											break
//line /usr/local/go/src/math/rand/normal.go:53
					// _ = "end of CoverTab[2965]"
				} else {
//line /usr/local/go/src/math/rand/normal.go:54
...
//line /usr/local/go/src/math/rand/normal.go:55
			// _ = "end of CoverTab[2961]"
//line /usr/local/go/src/math/rand/normal.go:55
			_go_fuzz_dep_.CoverTab[2962]++
									if j > 0 {
//line /usr/local/go/src/math/rand/normal.go:56
				_go_fuzz_dep_.CoverTab[2967]++
										return rn + x
//line /usr/local/go/src/math/rand/normal.go:57
				// _ = "end of CoverTab[2967]"
			} else {
//line /usr/local/go/src/math/rand/normal.go:58
...
//line /usr/local/go/src/math/rand/normal.go:58
			_go_fuzz_dep_.CoverTab[2963]++
									return -rn - x
//line /usr/local/go/src/math/rand/normal.go:59
			// _ = "end of CoverTab[2963]"
		} else {
//line /usr/local/go/src/math/rand/normal.go:60
...
//line /usr/local/go/src/math/rand/normal.go:61
			_go_fuzz_dep_.CoverTab[2970]++
									return x
//line /usr/local/go/src/math/rand/normal.go:62
			// _ = "end of CoverTab[2970]"
		} else {
//line /usr/local/go/src/math/rand/normal.go:63
...
//line /usr/local/go/src/math/rand/normal.go:64
...
//line /usr/local/go/src/math/rand/normal.go:156
