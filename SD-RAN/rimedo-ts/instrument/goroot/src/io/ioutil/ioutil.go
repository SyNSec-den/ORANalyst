...
//line /usr/local/go/src/io/ioutil/ioutil.go:26
	_go_fuzz_dep_.CoverTab[20806]++
							return io.ReadAll(r)
//line /usr/local/go/src/io/ioutil/ioutil.go:27
	// _ = "end of CoverTab[20806]"
}
...
//line /usr/local/go/src/io/ioutil/ioutil.go:36
	_go_fuzz_dep_.CoverTab[20807]++
							return os.ReadFile(filename)
//line /usr/local/go/src/io/ioutil/ioutil.go:37
	// _ = "end of CoverTab[20807]"
}
...
//line /usr/local/go/src/io/ioutil/ioutil.go:45
	_go_fuzz_dep_.CoverTab[20808]++
							return os.WriteFile(filename, data, perm)
//line /usr/local/go/src/io/ioutil/ioutil.go:46
	// _ = "end of CoverTab[20808]"
}
...
//line /usr/local/go/src/io/ioutil/ioutil.go:69
	_go_fuzz_dep_.CoverTab[20809]++
							f, err := os.Open(dirname)
							if err != nil {
//line /usr/local/go/src/io/ioutil/ioutil.go:71
		_go_fuzz_dep_.CoverTab[20813]++
								return nil, err
//line /usr/local/go/src/io/ioutil/ioutil.go:72
		// _ = "end of CoverTab[20813]"
	} else {
//line /usr/local/go/src/io/ioutil/ioutil.go:73
		_go_fuzz_dep_.CoverTab[20814]++
//line /usr/local/go/src/io/ioutil/ioutil.go:73
		// _ = "end of CoverTab[20814]"
//line /usr/local/go/src/io/ioutil/ioutil.go:73
	}
//line /usr/local/go/src/io/ioutil/ioutil.go:73
	// _ = "end of CoverTab[20809]"
//line /usr/local/go/src/io/ioutil/ioutil.go:73
	_go_fuzz_dep_.CoverTab[20810]++
							list, err := f.Readdir(-1)
							f.Close()
							if err != nil {
//line /usr/local/go/src/io/ioutil/ioutil.go:76
		_go_fuzz_dep_.CoverTab[20815]++
								return nil, err
//line /usr/local/go/src/io/ioutil/ioutil.go:77
		// _ = "end of CoverTab[20815]"
	} else {
//line /usr/local/go/src/io/ioutil/ioutil.go:78
		_go_fuzz_dep_.CoverTab[20816]++
//line /usr/local/go/src/io/ioutil/ioutil.go:78
		// _ = "end of CoverTab[20816]"
//line /usr/local/go/src/io/ioutil/ioutil.go:78
	}
//line /usr/local/go/src/io/ioutil/ioutil.go:78
	// _ = "end of CoverTab[20810]"
//line /usr/local/go/src/io/ioutil/ioutil.go:78
	_go_fuzz_dep_.CoverTab[20811]++
							sort.Slice(list, func(i, j int) bool {
//line /usr/local/go/src/io/ioutil/ioutil.go:79
		_go_fuzz_dep_.CoverTab[20817]++
//line /usr/local/go/src/io/ioutil/ioutil.go:79
		return list[i].Name() < list[j].Name()
//line /usr/local/go/src/io/ioutil/ioutil.go:79
		// _ = "end of CoverTab[20817]"
//line /usr/local/go/src/io/ioutil/ioutil.go:79
	})
//line /usr/local/go/src/io/ioutil/ioutil.go:79
	// _ = "end of CoverTab[20811]"
//line /usr/local/go/src/io/ioutil/ioutil.go:79
	_go_fuzz_dep_.CoverTab[20812]++
							return list, nil
//line /usr/local/go/src/io/ioutil/ioutil.go:80
	// _ = "end of CoverTab[20812]"
}
...
//line /usr/local/go/src/io/ioutil/ioutil.go:87
	_go_fuzz_dep_.CoverTab[20818]++
							return io.NopCloser(r)
//line /usr/local/go/src/io/ioutil/ioutil.go:88
	// _ = "end of CoverTab[20818]"
}
