...
//line /usr/local/go/src/net/sock_cloexec.go:19
	_go_fuzz_dep_.CoverTab[16111]++
							s, err := socketFunc(family, sotype|syscall.SOCK_NONBLOCK|syscall.SOCK_CLOEXEC, proto)
							if err != nil {
//line /usr/local/go/src/net/sock_cloexec.go:21
		_go_fuzz_dep_.CoverTab[16113]++
								return -1, os.NewSyscallError("socket", err)
//line /usr/local/go/src/net/sock_cloexec.go:22
		// _ = "end of CoverTab[16113]"
	} else {
//line /usr/local/go/src/net/sock_cloexec.go:23
		_go_fuzz_dep_.CoverTab[16114]++
//line /usr/local/go/src/net/sock_cloexec.go:23
		// _ = "end of CoverTab[16114]"
//line /usr/local/go/src/net/sock_cloexec.go:23
	}
//line /usr/local/go/src/net/sock_cloexec.go:23
	// _ = "end of CoverTab[16111]"
//line /usr/local/go/src/net/sock_cloexec.go:23
	_go_fuzz_dep_.CoverTab[16112]++
							return s, nil
//line /usr/local/go/src/net/sock_cloexec.go:24
	// _ = "end of CoverTab[16112]"
}
